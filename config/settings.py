...
SECRET_KEY = 'django-insecure-y7#4-h4l*94)l^n%c7pom=_-(!e5oeaik2!4a8pa7+p0!#fcb='
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'rest_framework_simplejwt.authentication.JWTAuthentication',  # Используем JWT аутентификацию
    ),
